...
/**
 * Management link for Environment ACL configuration This adds an entry to the "Manage Jenkins" page
 */
@Extension
public class EnvironmentACLManagementLink extends ManagementLink {
    ...
    /** Get the configuration instance for the view This method is called from the Jelly template */
