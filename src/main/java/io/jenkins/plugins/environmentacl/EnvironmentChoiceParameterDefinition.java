...
public class EnvironmentChoiceParameterDefinition extends ParameterDefinition {
    ...
    public EnvironmentChoiceParameterDefinition(String name, String description, String defaultValue, 
                                               boolean showOnlyAccessible, String environmentGroupFilter) {
    ...
    private List<String> getUserGroups(User user) {
        ...
        try {
            ...
            LOGGER.warning("Could not retrieve user groups for " + user.getId() + ": " + e.getMessage());
        }
    ...
    private String getCurrentJobName() {
        try {
            ...
            LOGGER.fine("Could not determine job name from context: " + e.getMessage());
        }
        return null;
    }
