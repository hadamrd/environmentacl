...
public class ACLRule extends AbstractDescribableImpl<ACLRule> {
    ...
    public ACLRule(String name, String type, int priority, List<String> jobs,
                   List<String> environments, List<String> envCategories, 
    ...
    public boolean equals(Object o) {
        ...
        return priority == aclRule.priority && 
               Objects.equals(name, aclRule.name);
    }
